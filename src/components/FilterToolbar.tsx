    ...
    <div className="space-y-4 max-w-xl mx-auto">
      <div className="flex items-center gap-3 flex-wrap">
        <button
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap transition-all border ${
            filters.onlyOpen
              ? 'bg-[#ff8000] text-white border-[#ff8000] shadow-sm'
        ...
        {hasActiveFilters && (
          <button
            ...
            className="ml-auto text-sm text-[#ff8000] hover:text-[#ff6600] font-medium"
          >
            Zurücksetzen
          </button>
        )}
      ...
      <div>
        <select
          ...
          className="w-full px-4 py-2.5 rounded-lg text-sm font-medium border border-gray-300 bg-white text-gray-700 hover:border-gray-400 focus:ring-blue-500 focus:border-blue-500 outline-none cursor-pointer transition-all"
        >
